...
std::string prefix_file_name = "scratch/CIS549";
int Scenario = 0;
uint16_t numberUE = 1;
...
int main(int argc, char *argv[]) {
    ...
    cmd.AddValue("delayValueforLte", "Link delay in msec between the router and PGW", delayValueforLte);
...
//------------------------------------------------------------------------------//
	...
	//internet.EnablePcapIpv4("router_interface_towards_pgw", internetIpIfaces2.Get(1).first, 2, false);
